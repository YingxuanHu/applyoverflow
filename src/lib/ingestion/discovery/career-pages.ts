...
const CAREER_PATH_HINTS = [
  ...
  "/careers/find-roles",
  "/careers/search-jobs",
  "/careers/search-roles",
  "/careers/browse-jobs",
  "/careers/browse-roles",
  "/careers/view-jobs",
  "/careers/view-roles",
  "/join-us",
  "/work-with-us",
...
const CAREER_KEYWORD_RE =
  /(careers?|jobs?|job board|all jobs|all roles|all open roles|explore(?: all)? jobs|explore roles?|explore opportunities|find a job|find jobs|find roles?|find your role|find your next role|search jobs|search roles?|search openings?|browse jobs|browse roles?|browse openings?|see jobs|see roles?|see openings?|view jobs|view roles?|view openings?|view positions?|current jobs|current roles?|current openings?|current opportunities|available jobs|available roles?|available positions?|available opportunities|opportunit(?:y|ies)|career opportunities|join(?: us| our team| the team|-us|-our-team|-the-team)|work(?: with us| for us| here|-with-us|-for-us|-here)|employment|talent|hiring|now hiring|openings?|open[- ]roles?|open[- ]positions?|open[- ]jobs?|open[- ]opportunities|vacanc(?:y|ies))/i;
